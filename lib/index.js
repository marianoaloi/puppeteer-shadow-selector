    ...
    return page.waitForSelector(parsedSelector.mainSelector).then(function () {
        return page
            ...
            function query(selector, context) {
                var shadowRoot = Array.from(context.querySelectorAll(selector.mainSelector)).map(function (x) { return x.shadowRoot; }).map(function (x) {
                    if (!shadowRoot)
                        return null;
                    if (typeof selector.shadowDOMSelector === "string")
                        return x === null || x === void 0 ? void 0 : x.querySelector(selector.shadowDOMSelector);
                    else
                        return query(selector.shadowDOMSelector, x || context);
                }
